...
namespace DecimalEx.Tests.DecimalExTrigTests
{
    ...
    public class ACosTests
    {
        ...
        {
            new[] { -1m, DecimalEx.Pi, 0m },
            new[] { 0m, DecimalEx.PiHalf, 0m },
            new[] { 1m, 0m, 0m },
        };
        ...
        {
            new[] { -1m + DecimalEx.SmallestNonZeroDec, 3.1415926535897790963270196523m, 1m },
            ...
            new[] { 1m - DecimalEx.SmallestNonZeroDec, 0.0000000000000141421356237310m, 0m },
        };
