...
namespace MathExtensions.Tests.MathExtTests
{
    ...
    public class ATan2Tests
    {
        ...
        {
            new[] { 0m, 0m, 0m, 0m },
            new[] { 1m, 0m, MathExt.PiHalf, 0m },
            new[] { -1m, 0m, -MathExt.PiHalf, 0m },
            new[] { 0m, 1m, 0, 0m },
            new[] { 0m, -1m, MathExt.Pi, 0m },
        };
        ...
        public void TestSpecialCases(decimal y, decimal x, decimal expected, decimal tolerance)
        {
            ...
            Assert.That(MathExt.ATan2(y, x), Is.EqualTo(expected).Within(tolerance));
        }

        public static decimal[][] TestCases =
        {
            new[] { 1m, 1m, MathExt.PiQuarter, Tolerance },
            new[] { 1m, -1m, MathExt.PiHalf + MathExt.PiQuarter, Tolerance },
            new[] { -1m, -1m, -(MathExt.PiHalf + MathExt.PiQuarter), Tolerance },
            new[] { -1m, 1m, -MathExt.PiQuarter, Tolerance },
