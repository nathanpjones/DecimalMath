...
namespace MathExtensions.Tests.MathExtTests
{
    ...
    public class ASinTests
    {
        ...
        public void TestSpecialCases(decimal d, decimal expected, decimal tolerance)
        {
            ...
            Assert.That(MathExt.ASin(d), Is.EqualTo(expected).Within(tolerance));
        }

        public static decimal[][] TestCases =
        {
            new[] { -1m + MathExt.SmallestNonZeroDec, -1.5707963267948824770956979607m, 11m },
