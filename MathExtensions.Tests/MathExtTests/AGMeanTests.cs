...
namespace MathExtensions.Tests.MathExtTests
{
    ...
    public class AGMeanTests
    {
        ...
        public static decimal[][] TestCases =
        {
                ...
                new[] {MathExt.SmallestNonZeroDec, 372843828m, 6842214.3831477590161m, Tolerance}, // full result would be 6842214.3831477590161357941832 but for loss of precision
        };
        ...
        public void Test(decimal x, decimal y, decimal expected, decimal tolerance)
        {
            ...
            Assert.That(MathExt.AGMean(x, y), Is.EqualTo(expected).Within(tolerance));
        }
        ...
        {
            Assert.Throws<Exception>(() => MathExt.AGMean(-3, 6));
            Assert.Throws<Exception>(() => MathExt.AGMean(3, -6));
        }
    }
