namespace DecimalMath
{
    ...
    /// </remarks>
    public class Transform2D : TransformationMatrixBase<Transform2D>
    {
        ...
        public Transform2D()
            : base(3)
        { }
        public Transform2D(decimal[,] values)
            : base(3, values)
        { }
        ...
        /// <summary>
        /// Scales around the origin. Returns a new matrix with the result.
        /// </summary>
        /// <param name="scaleX">Scale factor in X.</param>
        /// <param name="scaleY">Scale factor in Y.</param>
        public Transform2D Scale(decimal scaleX, decimal scaleY)
        {
        ...
        /// <summary>
        /// Scale around a given point.  Returns a new matrix with the result.
        /// </summary>
        ...
        /// <param name="scaleX">Scale factor in X.</param>
        /// <param name="scaleY">Scale factor in Y.</param>
        public Transform2D ScaleAt(decimal x, decimal y, decimal scaleX, decimal scaleY)
        {
        ...
        /// <summary>
        /// Rotates about a given point. Returns a new matrix with the result.
        /// </summary>
        ...
        /// If True, then + degrees rotates clockwise. Of course, if the sign of the degrees
        /// is -, then the rotation will be opposite whatever the + direction is.</param>
        public Transform2D RotateAt(decimal x, decimal y, decimal degrees, bool clockwise = false)
        {
        ...
        /// If True, then + degrees rotates clockwise. Of course, if the sign of the degrees
        /// is -, then the rotation will be opposite whatever the + direction is.</param>
        public Transform2D RotateAt(Point2D pt, decimal degrees, bool clockwise = false)
        {
        ...
        /// <summary>
        /// Mirrors across line that passes through the given points. Returns a new matrix with the result.
        /// </summary>
        /// <param name="pt1">A point.</param>
        /// <param name="pt2">A point.</param>
        public Transform2D Mirror(Point2D pt1, Point2D pt2)
        {
        ...
        /// a point from (0,0) by X = 1, Y = 2 will yield (1,2).  Returns a new matrix with the result.
        /// </summary>
        /// <param name="x">The X distance to translate.</param>
        /// <param name="y">The Y distance to translate.</param>
        public Transform2D Translate(decimal x, decimal y)
        {
